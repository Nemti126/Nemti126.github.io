        ...
        for (var i = 0, len = feat.length; i < len; i++) {
          tableData.push({
            ...
            totalTestEncountersViral:
              feat[i].properties.totalTestEncountersViral,
            ...
            totalTestsPeopleAntibody:
              feat[i].properties.totalTestsPeopleAntibody,
            positiveTestsPeopleAntibody:
              feat[i].properties.positiveTestsPeopleAntibody,
            negativeTestsPeopleAntibody:
              feat[i].properties.negativeTestsPeopleAntibody,
            totalTestsPeopleAntigen: feat[i].properties.totalTestsPeopleAntigen,
            positiveTestsPeopleAntigen:
              feat[i].properties.positiveTestsPeopleAntigen,
            ...
            totalTestResultsIncrease:
              feat[i].properties.totalTestResultsIncrease,
