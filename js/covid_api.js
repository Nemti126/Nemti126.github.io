        ...
        for (var i = 0, len = feat.length; i < len; i++) {
          tableData.push({
            ...
            totalTestEncountersViral:
              feat[i].totalTestEncountersViral,
            ...
            totalTestsPeopleAntibody:
              feat[i].totalTestsPeopleAntibody,
            positiveTestsPeopleAntibody:
              feat[i].positiveTestsPeopleAntibody,
            negativeTestsPeopleAntibody:
              feat[i].negativeTestsPeopleAntibody,
            totalTestsPeopleAntigen: feat[i].totalTestsPeopleAntigen,
            positiveTestsPeopleAntigen:
              feat[i].positiveTestsPeopleAntigen,
            ...
            totalTestResultsIncrease:
              feat[i].totalTestResultsIncrease,
